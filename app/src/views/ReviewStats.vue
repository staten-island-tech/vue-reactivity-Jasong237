<template>
  <div>
    ...
    <p>My Best Album(s): {{ bestAlbums }} (Rating: {{ highestStars }})</p>
    <p>My Worst Album(s): {{ worstAlbums }} (Rating: {{ lowestStars }})</p>
    <p>Total Albums Reviewed: {{ reviewed }}</p>
    <p>Average Review Rating: {{ total }}</p>
  </div>
</template>
